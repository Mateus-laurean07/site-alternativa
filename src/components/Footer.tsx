        ...
        >
          ...
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
              <img 
                src="/images/logo/Alternativa Comederos - Horizontal branca2.png" 
                alt="Alternativa Cochos e Bebedouros" 
                style={{ height: 44, objectFit: "contain" }}
              />
            </div>
            <p style={{ color: "rgba(255,255,255,0.6)", fontSize: "0.9rem", lineHeight: 1.8, marginBottom: 20 }}>
              {language === "PT" ? "Desde 2011, parceiro ideal dos criadores. Pioneira em cochos plásticos de alta resistência e durabilidade." : "Since 2011, the ideal partner for breeders. Pioneer in high-resistance and durability plastic troughs."}
            </p>
            <div style={{ display: "flex", gap: 12 }}>
              {["instagram", "facebook", "youtube"].map((social) => (
                <a
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLElement).style.background = "var(--verde-medio)";
          ...
          {/* Produtos */}
          <div>
            <h4 style={{ color: "var(--ouro)", fontSize: "0.8rem", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 20, fontFamily: "Inter, sans-serif", fontWeight: 700 }}>
              {language === "PT" ? "Produtos" : "Products"}
            </h4>
            {["Protecocho", "Hidramax 1300", "Multicocho", "Nutrisilo", "Creep Feeding", language === "PT" ? "Autoabastecimento" : "Self-supplying"].map((item) => (
              <Link
                key={item}
                href={`/produtos`}
                className="footer-link"
              >
                <span style={{ color: "var(--verde-claro)", fontSize: "0.75rem" }}>›</span>
                {item}
              </Link>
            ))}
          </div>
          ...
          <div>
            ...
            {[
              { label: language === "PT" ? "Sobre Nós" : "About Us", href: "/sobre" },
              { label: "Blog", href: "/blog" },
              { label: language === "PT" ? "Contato" : "Contact", href: "/contato" },
              { label: language === "PT" ? "Orçamento" : "Quote", href: "/contato" },
              { label: language === "PT" ? "Manuais" : "Manuals", href: "/produtos" },
            ].map((item) => (
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <a href="https://wa.me/5565999902024" target="_blank" className="footer-link" rel="noreferrer">
