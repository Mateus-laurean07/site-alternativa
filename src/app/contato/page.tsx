...
export default function ContatoPage() {
  ...
  const contatos = [
    { icon: <MapPin size={24} />, titulo: language === "PT" ? "Endereço" : "Address", valor: "Lucas do Rio Verde / MT", link: "https://www.google.com/maps?q=Alternativa+Cochos+Plásticos,+Lucas+do+Rio+Verde+-+MT" },
