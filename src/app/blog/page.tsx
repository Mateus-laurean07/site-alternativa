    ...
    <>
      ...
      >
        ...
        <div
          style={{
            ...
            bottom: 0,
            background:
              "linear-gradient(135deg, rgba(15,26,16,0.95) 0%, rgba(26,58,31,0.85) 100%)",
            zIndex: 1,
          }}
        />
        ...
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          ...
          >
            {language === "PT"
              ? "Conteúdo especializado sobre pecuária, nutrição animal, manejo e tecnologia no campo."
              : "Specialized content on livestock, animal nutrition, handling, and technology in the field."}
          </motion.p>
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="container">
          <div
            style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 48 }}
          >
            {/* Posts */}
                    ...
                    <div style={{ padding: 32 }}>
                      ...
                      >
                        ...
                        >
                          {language === "PT"
                            ? post.categoria
                            : post.categoria_en || post.categoria}
                        </span>
                        <span
                          style={{
                            color: "var(--cinza-texto)",
                      ...
                      <div
                        style={{
                          ...
                          borderTop: expandedPosts[post.id]
                            ? "none"
                            : "1px solid var(--cinza-medio)",
                          paddingTop: expandedPosts[post.id] ? 0 : 20,
                          marginTop: expandedPosts[post.id] ? 0 : 20,
                        }}
                      >
                        <div
                          style={{
              ...
              >
                ...
                >
                  {language === "PT"
                    ...
                    : "Talk to our specialist via WhatsApp."}
                </p>
                <a
